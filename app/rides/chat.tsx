...
const RideHistoryScreen = () => {
  ...
  return (
    <View className="flex-1 bg-white p-4 py-10 mt-10">
      {/* Back Arrow */}
      {/* <TouchableOpacity
        onPress={() => router.back()}
      ...
      >
        ...
        <Text className="font-bold text-xl font-Montserrat-bold">
          rideDetails
        </Text>
      </TouchableOpacity> */}

      {/* Scrollable Ride History List */}
      <ScrollView>
...
//       <TouchableOpacity onPress={() => router.back()} className="mb-8 mt-5">
//         <Text className="text-black text-xl font-bold">←</Text>
//       </TouchableOpacity>

//       <ScrollView>
//         {rides.map((ride, index) => (
//           <TouchableOpacity key={index} onPress={() => handleRidePress(ride.id)}>
//             <View className="bg-gray-100 p-4 rounded-lg mb-4 py-3">
//               <Text className="text-gray-600 font-bold">{`${ride.date} ${ride.time}`}</Text>
//               <Text className="text-[#4B5320] font-bold">{ride.amount}</Text>
//               <Text className="font-bold">{ride.carType}</Text>
//               <Text className="text-gray-600 font-bold">{ride.carNumber}</Text>
//               <Text className="text-gray-600">{ride.pickup}</Text>
//               <Text className="text-gray-600">{ride.dropoff}</Text>
//             </View>
//           </TouchableOpacity>
