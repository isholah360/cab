    ...
    <View style={styles.container}>
      ...
      <View className="flex flex-row justify-between w-full px-5 py-1 ">
              ...
              >
                ...
                />
                {activeIcon === "home" && (
                  <Text className="text-white ml-1 pb-1 text-xl font-Montserrat-bold">Dashboard</Text>
                )}
              </TouchableOpacity>
              ...
              >
                ...
                />
                {activeIcon === "book" && (
                  <Text className="text-white ml-1 text-xl font-Montserrat-bold">Booking</Text>
                )}
              </TouchableOpacity>
              ...
              >
                ...
                />
                {activeIcon === "settings" && (
                  <Text className="text-white ml-1 text-xl font-Montserrat-bold">More</Text>
                )}
              </TouchableOpacity>
            </View>
      </View>
