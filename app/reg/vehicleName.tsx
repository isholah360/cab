...
const EditVehicleNameScreen = () => {
  ...
  const handleDone = async () => {
    try {
      await AsyncStorage.setItem("vehicleName", vehicleName);
...
export default EditVehicleNameScreen;
